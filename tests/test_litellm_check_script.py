...
from scripts.check_litellm import LiteLLMConfig, auth_header_value, connection_error_hint, extract_chat_message, masked
...
def test_extract_chat_message_omits_reasoning_fields():
    body = json.dumps({"choices": [{"message": {"content": "\n\nДа", "reasoning_content": "hidden"}}]}, ensure_ascii=False)

    assert extract_chat_message(body) == "Да"
