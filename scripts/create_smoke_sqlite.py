    ...
    for area_index, (ngdu, mest, area) in enumerate(
        ...
        for offset, year in enumerate(range(2014, 2026), start=1):
            ...
            row = {
                ...
                "dobycha_liq": liq,
                "dobycha_vody": water,
                "dobycha_nefti_m3": oil / 0.862,
                "dobycha_liq_m3": oil / 0.862 + water / 1.185,
                "dobycha_vody_m3": water / 1.185,
                "zakachka": inj,
                "wc": wc,
                ...
                "dobycha_nefti_cum_m3": oil_cum / 0.862,
                "dobycha_liq_cum_m3": oil_cum / 0.862 + water_cum / 1.185,
                "dobycha_vody_cum_m3": water_cum / 1.185,
